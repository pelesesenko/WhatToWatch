...
import FilmReviewsContainer from './film-reviews-container';
    ...
    <div className="movie-card__wrap movie-card__translate-top">
        <div className="movie-card__info">
          ...
          <div className="movie-card__desc">
            ...
            {currentInfoTab === FilmInfoTabs[0] ? <FilmOverview film={film} /> : null}
            {currentInfoTab === FilmInfoTabs[1] ? <FilmDetails film={film} /> : null}
            {currentInfoTab === FilmInfoTabs[2] ? <FilmReviewsContainer id={film.id} /> : null}
          </div>
        </div>
      </div>
  );
